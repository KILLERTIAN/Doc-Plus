  ...
  return (
    <div className="mainAboutContainer">
      ...
      <div class="Policy">
          ...
          <ol>
            <li class="list-head"><strong>Medical Advice Disclaimer</strong></li>
            ...
            <li class="list-head"><strong>Proprietary Rights</strong></li>
            ...
            <li class="list-head"><strong>User Information</strong></li>
